...
export const Footer = () => {
    return (
        <footer className={styles.wrapper}>
            ...
            <p><a href="tel:+918057656424">+91-8057656424</a></p>
            <p><a href="mailto:vyvipinyadav998@gmail.com">vyvipinyadav998@gmail.com </a> </p>
            ...
            <div className={styles.text}>Made with 💚 in Bangalore</div>
